...
const VELDONDERZOEK_THEMAS: VeldonderzoekThema[] = [
  {
    ...
    inzichten: [
      ...
      {
        toelichting: 'Knoop XL-gebied: bestaande huurders blijven voorlopig zitten maar nieuwe vestigers zijn huiverig — wie zich nu vestigt loopt risico over enkele jaren gedwongen te moeten verhuizen. Verhuur in dit gebied gaat daardoor moeizaam; bedrijven kiezen liever voor Strijp-S, Roggenwoud, Flight Forum of Eindhoven Airport.',
        persoon: 'Dirk Verberne',
      ...
      {
        toelichting: 'Twee gebiedsontwikkelingen met kantoorfocus in Rotterdam: (1) CBD Schiekeblok nabij Centraal Station — ~300.000 m² gepland maar traag door meerdere eigenaren en aflopende erfpachtcontracten; (2) Marconiplein/Keilenkwartier — mixed-use voor haven- en creatieve sector gecombineerd met een groot woningbouwprogramma.',
        persoon: 'Maurits de Peuter',
        organisatie: 'Schaub & Partners Bedrijfshuisvesting',
        datum: '30/05/26',
        stad: 'rotterdam',
  ...
  },
  {
    ...
    inzichten: [
      ...
      {
        toelichting: 'Bij installaties zijn partijen vaak gebonden aan de huisinstallateur van het gebouw — eigenaren willen niet dat elke partij aan hun systemen schuurt. Dit beperkt de keuzevrijheid van inrichtingspartijen bij technische aanpassingen. Fit-out benchmark: Varo Energy realiseerde ~€1.500/m² (2–3 jaar geleden, nu richting €2.000/m²); haven- en industriebedrijven hanteren aanzienlijk lager budget.',
        persoon: 'Maurits de Peuter',
        organisatie: 'Schaub & Partners Bedrijfshuisvesting',
        datum: '30/05/26',
        stad: 'rotterdam',
  ...
  },
  {
    ...
    inzichten: [
      ...
      {
        toelichting: 'Inrichtingskeuze ligt altijd bij de huurder — pandowner en gebiedsbeheerder (ook Park-Strijp-Beheer en Hightech Campus) kunnen adviseren maar niet verplichten. Ditt moet zich richten op de gebruikersmarkt, niet op gebiedsbeheerders als poortwachter voor opdrachten. Exacte concurrenten Eindhoven: VB Vastgoedinrichter, Den Bak Projecten, PGA, Markt Projecten, Totaal Kantoorinrichting en HAL 2.',
        persoon: 'Dirk Verberne',
        organisatie: 'Verschuuren & Scheppers Bedrijfsmakelaars',
        datum: '04/06/26',
        stad: 'eindhoven',
      ...
      {
        toelichting: 'Directe concurrenten van Ditt in Rotterdam: Planet Office, Leitmotiv en Desk zijn de meest relevante spelers naast de corporate tak (Ciguri/Tetris). Desk is vergelijkbaar met Ditt qua positionering en actief in meerdere steden. Wederkerigheid blijft het kerncriterium voor samenwerking — niet de financiële vergoeding maar de introductie bij huurders maakt het verschil.',
        persoon: 'Maurits de Peuter',
        organisatie: 'Schaub & Partners Bedrijfshuisvesting',
        datum: '30/05/26',
        stad: 'rotterdam',
