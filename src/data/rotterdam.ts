...

  {
    ...
    inzichten: [
      ...
      },
      {
        ...
        datum: '2026-05-30',
        categorie: 'marktdynamiek',
        inzicht: 'Directe concurrenten van Ditt in Rotterdam: Planet Office, Leitmotiv en Desk zijn de meest relevante spelers naast de corporate tak (Ciguri/Tetris). Desk is vergelijkbaar met Ditt qua positionering en is aanwezig in zowel Rotterdam als andere steden.',
      },
      {
        id: 'rc-inz-05',
        bron: 'Maurits de Peuter',
        ...
        inzicht: 'Belangrijke eigenaren Rotterdam naast bekende institutionele partijen: Maarse Groep (The Modernist), Schroeder Capital (Air Offices), Van Herk Groep (grote kantoorportefeuille) en DuDoc (monumentaal vastgoed, Houthof en logistiek). Particuliere eigenaren zijn in Rotterdam relatief dominant.',
      },
      {
        id: 'rc-inz-06',
        bron: 'Maurits de Peuter',
        ...
        datum: '2026-05-30',
        categorie: 'marktdynamiek',
        inzicht: 'Twee gebiedsontwikkelingen met kantoorfocus: (1) CBD Schiekeblok nabij Centraal Station — ~300.000 m² gepland maar traag door meerdere eigenaren en aflopende erfpachtcontracten; (2) Marconiplein/Keilenkwartier — mixed-use voor haven- en creatieve sector gecombineerd met een groot woningbouwprogramma.',
      },
      {
        id: 'rc-inz-07',
        bron: 'Maurits de Peuter',
