  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    inzichten: [
      ...
      },
      {
        ...
        datum: '2026-06-04',
        categorie: 'marktdynamiek',
        inzicht: 'Knoop XL-gebied: bestaande huurders blijven voorlopig zitten, maar nieuwe vestigers zijn huiverig — wie zich nu vestigt loopt risico over enkele jaren te moeten verhuizen. Verhuur in dit gebied gaat daardoor moeizaam. Bedrijven kiezen liever voor alternatieven als Strijp-S, Roggenwoud, Flight Forum of Eindhoven Airport.',
      },
      {
        id: 'fell-inz-04',
        bron: 'Dirk Verberne',
        ...
        datum: '2026-06-04',
        categorie: 'acquisitie',
        inzicht: 'Inrichtingskeuze ligt altijd bij de huurder — pandowner en gebiedsbeheerder (ook Park-Strijp-Beheer en Hightech Campus) kunnen adviseren maar niet verplichten. Ditt moet zich richten op de gebruikersmarkt en niet op gebiedsbeheerders als poortwachter voor opdrachten.',
      },
      {
        id: 'fell-inz-05',
        bron: 'Dirk Verberne',
